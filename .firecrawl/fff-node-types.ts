...
export interface FileItem {
 ...
 /\\*\\* Git status: 'clean', 'modified', 'untracked', 'staged\_new', etc. \*/
 gitStatus: string;
}
...
export function createGrepCursor(offset: number): GrepCursor {
 return { \_\_brand: "GrepCursor" as const, \_offset: offset };
}
...
export interface GrepResult {
 /\\*\\* Matched items with file and line information. At most \`max\_matches\_per\_file\`. \*/
 items: GrepMatch\[\];
