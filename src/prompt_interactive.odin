...
generate_context_feature :: proc(b: ^strings.Builder) {
	...
	fmt.sbprintln(b, "  elif [[ -f \"nim.cfg\" ]] || ls *.nim >/dev/null 2>&1; then")
	fmt.sbprintln(b, `    _WAYU_CONTEXT="nim"`)
	fmt.sbprintln(b, "  elif [[ -f \"dune\" ]] || ls *.ml >/dev/null 2>&1; then")
	...
	fmt.sbprintln(b, "  elif ls *.fnl >/dev/null 2>&1; then")
	fmt.sbprintln(b, `    _WAYU_CONTEXT="fennel"`)
	fmt.sbprintln(b, "  elif [[ -f \"cpanfile\" ]] || ls *.pl >/dev/null 2>&1; then")
	...
	fmt.sbprintln(b, "  elif ls *.kt >/dev/null 2>&1 || ls *.kts >/dev/null 2>&1; then")
	fmt.sbprintln(b, `    _WAYU_CONTEXT="kotlin"`)
	fmt.sbprintln(b, "  elif [[ -f \"go.mod\" ]]; then")
	fmt.sbprintln(b, `    _WAYU_CONTEXT="golang"`)
	fmt.sbprintln(b, "  elif [[ -f \"ols.json\" ]] || ls *.odin >/dev/null 2>&1; then")
	...
	fmt.sbprintln(b, "  elif [[ -f \"DESCRIPTION\" ]] || ls *.R >/dev/null 2>&1; then")
	fmt.sbprintln(b, `    _WAYU_CONTEXT="rlang"`)
	fmt.sbprintln(b, "  elif [[ -f \".lua-version\" ]] || ls *.lua >/dev/null 2>&1; then")
	...
	fmt.sbprintln(b, "  elif ls *.c >/dev/null 2>&1 || ls *.h >/dev/null 2>&1; then")
	fmt.sbprintln(b, `    _WAYU_CONTEXT="c"`)
	fmt.sbprintln(b, "  elif ls *.cpp >/dev/null 2>&1 || ls *.hpp >/dev/null 2>&1; then")
